...
CREATE TABLE IF NOT EXISTS "room_links" (
    "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "from_room_id" INTEGER NOT NULL REFERENCES "room"("id") ON DELETE CASCADE,
    "to_room_id" INTEGER NOT NULL REFERENCES "room"("id") ON DELETE CASCADE,
    "door_description" TEXT, -- Optionnel, pour décrire la porte ou le lien
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ
);
...
CREATE TABLE IF NOT EXISTS "cell" (
    ...
    "room_id_link" INTEGER REFERENCES "room"("id"),  -- Cette colonne référence la Room vers laquelle cette Cell pointe
    "item_id" INTEGER REFERENCES "item"("id"),
